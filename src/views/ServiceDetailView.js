...
class ServiceDetailView extends React.Component {
  ...
  render() {
    const proxies = ServiceDetailView.Controller !== ServiceDetailView ? transformProxies(this.props.children) : {
          ...
          <div>
            <div data-w-id="a1e4a4fe-8958-4d97-d653-0e5ab1a1f9e9" data-animation="default" data-collapse="medium" data-duration={60} data-easing="linear" data-easing2="linear" role="banner" className="af-class-navbar w-nav">
              <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                ...
                <a href="service-detail.html" aria-current="page" className="af-class-nav-link w-nav-link w--current">Services</a>
                        ...
                        <div role="list" className="w-dyn-items">
                          <div role="listitem" className="w-dyn-item">
                            <a href="#" className="af-class-project-grid-item w-inline-block">
                              <div data-w-id="fca5466a-967c-df56-333b-079249f46425" className="af-class-project-grid-info"><img src loading="lazy" alt className="af-class-project-grid-image" />
                                <div className="af-class-project-view-circle">View</div>
                              </div>
                              <h5 className="af-class-project-grid-title" />
                            </a>
                          </div>
                        </div>
                    ...
                    <div className="af-class-project-slide w-slide">
                      <div className="w-dyn-list">
                        <div role="list" className="w-dyn-items">
                          <div role="listitem" className="w-dyn-item">
                            <a href="#" className="af-class-project-grid-item w-inline-block">
                              <div data-w-id="fca5466a-967c-df56-333b-079249f46432" className="af-class-project-grid-info"><img src loading="lazy" alt className="af-class-project-grid-image" />
                                <div className="af-class-project-view-circle">View</div>
                              </div>
                              <h5 className="af-class-project-grid-title" />
                            </a>
                    ...
                    <div className="af-class-project-slide w-slide">
                      <div className="w-dyn-list">
                        <div role="list" className="w-dyn-items">
                          <div role="listitem" className="w-dyn-item">
                            <a href="#" className="af-class-project-grid-item w-inline-block">
                              <div data-w-id="fca5466a-967c-df56-333b-079249f4643f" className="af-class-project-grid-info"><img src loading="lazy" alt className="af-class-project-grid-image" />
                                <div className="af-class-project-view-circle">View</div>
                              </div>
                              <h5 className="af-class-project-grid-title" />
                            </a>
                    ...
                    <div className="af-class-project-slide w-slide">
                      <div className="w-dyn-list">
                        <div role="list" className="w-dyn-items">
                          <div role="listitem" className="w-dyn-item">
                            <a href="#" className="af-class-project-grid-item w-inline-block">
                              <div data-w-id="fca5466a-967c-df56-333b-079249f4644c" className="af-class-project-grid-info"><img src loading="lazy" alt className="af-class-project-grid-image" />
                                <div className="af-class-project-view-circle">View</div>
                              </div>
                              <h5 className="af-class-project-grid-title" />
                            </a>
