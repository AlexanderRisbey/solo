            ...
            <div className="af-class-team-detail-section af-class-wf-section">
              <div className="af-class-container w-container">
                <div className="w-layout-grid af-class-grid-team-detail">
                  <div id="w-node-d185f31a-bf10-bc83-8422-8895b0061947-8f44a816" className="af-class-team-detail-image-wrap"><img src loading="lazy" alt className="af-class-team-detail-image" /></div>
                  <div id="w-node-d185f31a-bf10-bc83-8422-8895b0061949-8f44a816" className="af-class-team-detail">
                    <div className="af-class-team-info">
                      ...
                      <div className="w-layout-grid af-class-team-detail-social">
                        <a href="#" className="af-class-team-detail-social-link w-inline-block"><img src="images/facebook.svg" loading="lazy" alt className="af-class-team-detail-social-icon" /></a>
                        <a href="#" className="af-class-team-detail-social-link w-inline-block"><img src="images/instagram-brands.svg" loading="lazy" alt className="af-class-team-detail-social-icon" /></a>
                        <a href="#" className="af-class-team-detail-social-link w-inline-block"><img src="images/linkedin.svg" loading="lazy" alt className="af-class-team-detail-social-icon" /></a>
                        <a href="#" className="af-class-team-detail-social-link w-inline-block"><img src="images/twitter.svg" loading="lazy" alt className="af-class-team-detail-social-icon" /></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="af-class-team-blog">
                  <div className="af-class-team-blog-title">
                    <h3>Blog by </h3>
                    <h3 />
                  </div>
                  <div className="w-dyn-list">
                    <div role="list" className="af-class-collection-list w-dyn-items">
                      <div role="listitem" className="af-class-blog-item w-dyn-item">
                        <a data-w-id="0bbc0e45-5bd2-16e6-ac97-09a76aa31d4d" href="#" className="af-class-blog-link w-inline-block">
