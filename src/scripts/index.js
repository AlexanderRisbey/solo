...
const scripts = [
  ...
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Poppins:regular,500","Antic Didone:regular","Dosis:200,300,regular,500,600,700,800","Noto Serif Hebrew:100,200,300,regular,500,600,700,800,900:hebrew,latin,latin-ext","Noto Serif:regular,italic,700,700italic:latin,latin-ext"]}});',
    isAsync: false,
  },
  {
    type: 'code',
